import { prepareEvidenceUpload } from "@/lib/services/evidence";

export const runtime = "nodejs";

/** Issue a signed Storage upload URL for Evidence (JSON only — Vercel-safe). */
export async function POST(request: Request) {
  try {
    ...
    const result = await prepareEvidenceUpload({
      filename,
      byteLength,
